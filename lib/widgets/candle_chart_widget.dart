...
class CandleChartWidget extends StatelessWidget {
  ...
  CandleChartWidget({required this.coinChart, this.graphColor = secondaryColor, this.selectedChartType = ChartMarketType.PRICES});
...
//        return ChartAxisLabel('${appStore.mSelectedCurrency!.symbol.validate()}${axisLabelRenderArgs.text.validate(value: 's').toInt().amountPrefix}', primaryTextStyle(size: 8));
//      },
