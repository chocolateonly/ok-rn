                              ...
                              children: [
                                TableRow(
                                  children: [
                                    ...
                                    Text('${getCurrencyPrefix(selectedValue)}${getExchangeFromDerivatives(selectedTypeValue, data.converted_last!)!.amountPrefix}', style: primaryTextStyle(size: 14), textAlign: TextAlign.start),
                                    Text(
