            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  NewMetricsWidget(isCurrencyAllowed: false, name: 'lbl_since_atl'.translate, value: '${getPercentageValueInCurrency(widget.marketData.atl_change_percentage!).validate().toStringAsFixed(2)}%'),
                ],
              ).expand(),
            ],
          )
